...
import { ArrowRight, Users, ShieldCheck, DollarSign } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col bg-background">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center max-w-4xl">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed">
              CrowdCivicFix empowers communities to identify, fund, and solve local issues through transparent collaboration and verified results.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/jobs">
                <Button size="lg" className="h-12 px-8 text-lg btn-primary rounded-full">
                  Browse Jobs
                </Button>
              </Link>
              <Link href="/auth">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="glass-panel p-8 rounded-2xl">
              ...
              <p className="text-muted-foreground">Local leaders initiate projects, neighbors contribute, and everyone benefits from a cleaner environment.</p>
            </div>
            ...
            <div className="glass-panel p-8 rounded-2xl">
              ...
              <p className="text-muted-foreground">Secure crowdfunding ensures resources are available before work starts. Funds are held in escrow.</p>
            </div>
            ...
            <div className="glass-panel p-8 rounded-2xl">
              ...
              <p className="text-muted-foreground">Workers provide photo proof of completion. Community leaders verify quality before funds are released.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="bg-secondary rounded-3xl p-12 text-center text-white relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              ...
              <p className="text-blue-100 mb-8 text-lg">
                Whether you want to lead a project, fund a cleanup, or do the work, there's a role for you.
              </p>
              <Link href="/auth?tab=register">
                <Button size="lg" variant="secondary" className="bg-white text-secondary hover:bg-white/90 font-bold h-12 px-8">
                  Get Started Now
                </Button>
              </Link>
            </div>
      ...
      <footer className="py-12 border-t mt-auto">
        <div className="container mx-auto px-4 text-center text-muted-foreground">
          <p>© 2024 CrowdCivicFix. Building better communities together.</p>
        </div>
      </footer>
    </div>
  );
